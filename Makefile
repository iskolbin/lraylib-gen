...
parse:
	...
	lua -e 'print("return", require("str.str")(require("parse")("raygui/src/raygui.h","RAYGUIDEF",require("aliases"))))' > raygui_defs.lua
...
bind:
	...
	lua -e 'require("bind")({libname = "raygui", prefix = "l", includes = {"raygui/src/raygui.h"}, defines = {"RAYGUI_IMPLEMENTATION","RAYGUI_TEXTBOX_EXTENDED","RAYGUI_RICONS_SUPPORT"}}, require("raygui_defs"), require("raygui_custom"))' > raygui_bind.c
