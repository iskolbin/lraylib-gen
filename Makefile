...
bind:
	lua -e 'require("bind")({libname = "raylib", prefix = "l_", includes = {"raylib/src/raylib.h", "raylib/src/rlgl.h", "isl_sleep/isl_sleep.h"}, defines = {"ISL_SLEEP_IMPLEMENTATION"}}, require("raylib_defs"), require("raylib_custom"))' > raylib_bind.c
